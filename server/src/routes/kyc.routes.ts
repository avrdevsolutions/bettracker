 ...
 *   get:
 *     tags: [KYC]
 *     summary: List all users with submitted KYC (admin only)
 *     security:
 *       - bearerAuth: []
 *     responses:
 *       200:
 *         description: List of submitted KYC users with their documents
 */
router.get('/submissions', authMiddleware, kycController.getSubmissions);
